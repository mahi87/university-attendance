...
class TestProbabilityToMissGradCeremony(unittest.TestCase):
    def test_should_return_probability_to_miss_grad_ceremony_in_string_format_for_5_days(
        self,
    ):
        no_of_academic_days = 5
    ...
    def test_should_return_probability_to_miss_grad_ceremony_in_string_format_for_10_days(
        self,
    ):
        no_of_academic_days = 10
